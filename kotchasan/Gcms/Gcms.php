...
class Gcms extends \Kotchasan\KBase
{
	 ...
	 * @return bool คืนค่า true ถ้าสมาชิกที่ login มีสถานะที่กำหนดอยู่ใน $cfg->$key หรือ $cfg[$key]
	 */
	 ...
	 * @param bool $txt (optional) true=เปลี่ยน tab เป็นช่องว่าง 4 ตัวอักษร (default false)
	 * @return string
	 */
	 ...
	 *
	 * @param string $module
	 * @return bool ถ้าเป็นโมดูลแรกที่ติดตั้ง (เป็นหน้าหลัก) คืนค่า true
	 */
