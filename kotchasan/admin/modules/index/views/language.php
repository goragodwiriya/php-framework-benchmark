...
class View extends \Kotchasan\View
{
	...
	public function render()
	{
		...
		$table = new DataTable(array(
			...
			'sortType' => self::$request->cookie('language_sortType', 'desc')->toString(),
			...
			'actions' => array(
				...
				array(
					...
					'href' => $uri->withParams(array('module' => 'languageedit', 'id' => -1, 'type' => $type), true)
				)
			),
			'buttons' => array(
				array(
					'class' => 'icon-edit button green',
					'href' => $uri->withParams(array('module' => 'languageedit', 'id' => ':id', 'type' => $type), true),
		...
		setcookie('language_sortType', $table->sortType, time() + 3600 * 24 * 365, '/');
		return $table->render();
	}
