...
class View extends \Kotchasan\View
{
	...
	public function render($menu)
	{
		...
		$fieldset->add('text', array(
			...
			'itemClass' => 'item',
			'label' => Language::get('Text on menu'),
		...
		$fieldset->add('select', array(
			...
			'label' => Language::get('Modules already installed'),
		...
		$fieldset->add('text', array(
			...
			'comment' => Language::get('Links for this menu, which will open this page when click on the menu'),
			'value' => $menu->menu_url
		));
		// menu_target
		$fieldset->add('select', array(
			...
			'comment' => Language::get('How to turn the page of this menu'),
