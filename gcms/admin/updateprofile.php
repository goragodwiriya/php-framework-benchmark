...
if (gcms::isReferer() && gcms::isMember()) {
    if (isset($_SESSION['login']['account']) && $_SESSION['login']['account'] == 'demo') {
        ...
        $save['subscrib'] = gcms::getVars($_POST, 'register_subscrib', 0) == 1 ? 1 : 0;
        $save['admin_access'] = gcms::getVars($_POST, 'register_admin_access', 0) == 1 ? 1 : 0;
        ...
        if ($id > 0 && !$user) {
            ...
            if (!$error) {
                ...
                if (isset($user['id']) && $_SESSION['login']['id'] == $user['id'] && !empty($save['password'])) {
